...
const Home = () => {
  ...
  const handleSearchChange =  (e) => {
    ...
    setSearchTimeout (
      setTimeout(() => {
        const serachResult = allPosts.filter((item) => item.name.toLowerCase().includes(searchText.toLowerCase()) || item.prompt.toLowerCase().includes(searchText.toLocaleLowerCase()));
